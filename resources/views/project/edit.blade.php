                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <button type="submit"
                                                    onclick="updateProject({{ $result->id }}); return false;"
...
@section('script')
    <script>
        ...
        async function updateProject(id) {
            ...
            let response = await postData('{{ url('api/v1/projects/edit') }}/' + id, data, 'POST')
            if (response.success) {
                ...
                Swal.fire({
                    title: 'Projects',
                    text: "Update project failed!: "+ JSON.stringify(response.message),
                    icon: 'warning',
